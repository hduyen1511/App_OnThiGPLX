...
import static com.example.GPLX.Activities.ThiSatHachActivity.soCauDung;
...
public class KetQuaActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void setControl(){
        ...
        if (SIZE == 20){
            ...
            if (soCauDung<16){
                img_ketQua.setImageDrawable(getDrawable(this,"truotchots"));
            } else {
                img_ketQua.setImageDrawable(getDrawable(this,"dochots"));
            }
        } else if (SIZE == 30){
